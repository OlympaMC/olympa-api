...
public class Scoreboard {
	...
	class Line<T extends OlympaPlayer> {
		 ...
		 * <li>If there is quests placeholders (<code>{questName}</code> or
		 * <code>{questDescription}</code>) they will be replaced by the appropriated
		 * value
		 ...
		 * <li>If there is more lines than the previous time, all lines up are moved
		 * forward
