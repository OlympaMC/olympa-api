...
public class PlayerBlockInteractFlag extends AbstractProtectionFlag {
	...
	public void interactEvent(PlayerInteractEvent event) {
		if (handleBlocksInventory && INVENTORY_BLOCK.contains(event.getClickedBlock().getType())) {
