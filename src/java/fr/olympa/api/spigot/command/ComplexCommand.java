...
import fr.olympa.api.common.command.complex.CommandArgsType;
import fr.olympa.api.common.command.complex.CommandContext;
import fr.olympa.api.common.command.complex.IArgument;
import fr.olympa.api.common.command.complex.IComplexCommand;
import fr.olympa.api.common.command.complex.InternalCommand;
import fr.olympa.api.common.command.complex.Parser;
		...
		for (Method method : clazz.getDeclaredMethods())
			if (method.isAnnotationPresent(Cmd.class)) {
				...
				OlympaCore.getInstance()
						.sendMessage("Error when loading command annotated method " + method.getName() + " in class " + method.getDeclaringClass().getName() + ". Required argument: fr.olympa.api.common.command.complex.CommandContext");
			}
	}
