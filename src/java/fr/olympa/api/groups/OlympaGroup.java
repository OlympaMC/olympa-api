...
public enum OlympaGroup {
	...
	RESP_TECH(5, 80, OlympaServer.ALL, "Resp._Technique", "Resp._Technique", "&3%s ", ":&r", true),
	...
	GAMEMASTER(6, 67, OlympaServer.ALL, "GameMaster", "GameMaster", "&c%s ", ":&r", true),
	RESP_STAFF(9, 65, OlympaServer.ALL, "Resp._Staff", "Resp._Staff", "&c%s ", ":&r", true),
	RESP_COM(5, 80, OlympaServer.ALL, "Resp._Communication", "Resp._Communication", "&3%s ", ":&r", true),
	RESP_ANIMATION(10, 60, OlympaServer.ALL, "Resp._Animateur", "Resp._Animatrice", "&3%s ", ":&r", true),
	RESP_BUILDER(11, 55, OlympaServer.ALL, "Resp._Buildeur", "Resp._Buildeuse", "&a%s ", ":&r", true),
