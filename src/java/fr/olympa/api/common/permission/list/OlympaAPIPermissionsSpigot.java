...
public class OlympaAPIPermissionsSpigot {
	...
	public static final OlympaSpigotPermission BYPASS_PERM_NOT_EXIST = new OlympaSpigotPermission(OlympaGroup.RESP_TECH, new OlympaGroup[] { OlympaGroup.DEVP, OlympaGroup.DEV, OlympaGroup.GAMEDESIGNER });
