...
public class OlympaAPIPermissionsSpigot {
	...
	public static final OlympaSpigotPermission SAY_COMMAND = new OlympaSpigotPermission(OlympaGroup.MODP, OlympaGroup.DEV, OlympaGroup.DEVP);
	...
	public static final OlympaSpigotPermission GAMEMODE_COMMAND = new OlympaSpigotPermission(OlympaGroup.MOD, OlympaGroup.DEVP);
	public static final OlympaSpigotPermission GAMEMODE_COMMAND_CREATIVE = new OlympaSpigotPermission(OlympaGroup.MODP, OlympaGroup.DEVP);
	public static final OlympaSpigotPermission GAMEMODE_COMMAND_OTHER = new OlympaSpigotPermission(OlympaGroup.MODP, OlympaGroup.DEVP);
	...
	public static final OlympaSpigotPermission VANISH_COMMAND_HIDE_STAFF = new OlympaSpigotPermission(OlympaGroup.MODP, OlympaGroup.DEVP);
	public static final OlympaSpigotPermission VANISH_SEE_ADMIN = new OlympaSpigotPermission(OlympaGroup.MODP, OlympaGroup.DEVP);
	...
	public static final OlympaSpigotPermission GOD_COMMAND = new OlympaSpigotPermission(OlympaGroup.MODP, OlympaGroup.DEVP);
