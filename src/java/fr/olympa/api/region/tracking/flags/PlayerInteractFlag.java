...
public class PlayerInteractFlag extends AbstractProtectionFlag {
	...
	public PlayerInteractFlag(boolean protectedByDefault, boolean handleBlocksInventory, boolean blockInventoryProtected) {
	...
	public void interactEvent(PlayerInteractEvent event) {
		if (handleBlocksInventory) {
			handleCancellable(event, inventoryBlocks.contains(event.getClickedBlock().getType()) ? blockInventoryProtected : false);
		}else handleCancellable(event);
	}
