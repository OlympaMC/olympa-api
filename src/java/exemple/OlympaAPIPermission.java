...
public class OlympaAPIPermission {
	...
	public static final OlympaPermission CONNECT_SERVERSTATUS_DEV = new OlympaPermission(new OlympaGroup[] { OlympaGroup.DEV }, OlympaGroup.RESP_TECH);
	...
	public static final OlympaPermission CONNECT_SERVERSTATUS_MAINTENANCE = new OlympaPermission(OlympaGroup.DEV, OlympaGroup.RESP_TECH);
